...
if __name__ == "__main__":
    ...
    for alpha in alphas:
        ...
        plt.tight_layout()
        plt.savefig("./graphs/ts_random_alpha_" + str(alpha) + ".png")

        print()
        print("Alpha: ", alpha)
        print("Method: Mean Reward, Reward Std, Mean Num. Attack Success")
        ...
        plt.tight_layout()
        plt.savefig("./graphs/random_alpha_" + str(alpha) + ".png")