...
if __name__ == "__main__":
    ...
    for alpha in alphas:
        ...
        plt.xlabel("Timestep")
        plt.savefig("./graphs/evolving/ts_stochastic_evolve_high_sc_alpha_" + str(alpha) + ".png")
        ...
        # print("Number of times on an average between 330 and 400 ATA-MDP selected {Python, PostgreSQL}: ", mdp_adapt/iter)
        ...
        plt.tight_layout()
        plt.savefig("./graphs/evolving/stochastic_evolve_high_sc_alpha_" + str(alpha) + ".png")
