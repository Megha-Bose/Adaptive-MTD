    ...
    for alpha in alphas:
        ...
        for it in range(iter):
            ...
            for num in range(timesteps):
                ...
                eps_greedy_state_weights[current_eps_greedy_action]+=(M-(attack_success*attack_loss[current_eps_greedy_state][current_eps_greedy_action][current_eps_greedy_att_type]))-(alpha*switching_costs[(current_eps_greedy_state, current_eps_greedy_action)])
